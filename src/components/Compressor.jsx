              ...
              <AnimatePresence mode="wait">
                {loading ? (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="border border-[#2e2e2e] bg-[#0a0a0a] p-16 flex flex-col items-center justify-center space-y-6"
                  >
                    ...
                    <div className="text-center space-y-2">
                      <p className="text-[10px] uppercase font-bold tracking-[0.3em] text-white">
                        Optimizing Engine
                      </p>
